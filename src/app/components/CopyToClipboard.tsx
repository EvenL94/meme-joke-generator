...
const CopyToClipboard: React.FC<copyToClipboardProp> = ({ toCopy }) => {
  ...
  return (
    <div className="flex items-center relative bg-blue-100 text-token-text-secondary bg-token-main-surface-secondary px-4 py-2 text-base font-sans justify-between rounded-t-md">
      <span>点击选框输入内容</span>
      <button
